...
export default {
  ...
  mounted () {
    this.$http.get(api.releaseList(), {channel: 'pc', category: '01', stick: '0', limit: 8, offset: 0}, (res) => {
      this.newsTypeList[0].newsList = res.data.rows
    })
    this.$http.get(api.releaseList(), {channel: 'pc', category: '02', stick: '0', limit: 8, offset: 0}, (res) => {
