...
import com.yiyun.domain.ColumnDO;
import com.yiyun.domain.TableDO;
import com.yiyun.utils.DateUtil;
import com.yiyun.web.common.config.Constant;
...
//        templates.add("templates/common/generator/ClusterDao.java.vm");
//        templates.add("templates/common/generator/ClusterAdressMapper.xml.vm");
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        map.put("datetime", DateUtil.date2date(new Date(), DateUtil.YYYY_MM_DD_HH_MM_SS));
