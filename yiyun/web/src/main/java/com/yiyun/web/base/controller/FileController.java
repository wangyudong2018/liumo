...
import com.yiyun.domain.FileDO;
import com.yiyun.utils.FileUtil;
import com.yiyun.utils.PageUtil;
import com.yiyun.web.base.service.FileService;
...
//		Map<String, Object> params = new HashMap<>(16);
	...
	public PageUtil list(@RequestParam Map<String, Object> params) {
		...
		PageUtil pageUtil = new PageUtil(sysFileList, total);
		return pageUtil;
	}
	...
	@RequiresPermissions("common:edit")
