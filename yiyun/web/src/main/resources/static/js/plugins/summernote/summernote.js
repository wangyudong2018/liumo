...
(function (factory) {
  ...
  var func = (function () {
     ...
     * @sysParam {Function} func
     * @sysParam {Number} wait
     * @sysParam {Boolean} immediate
     * @return {Function}
     */
  ...
  var list = (function () {
     ...
     * get sum from a list
     *
     * @sysParam {Array} array - array
     * @sysParam {Function} fn - iterator
     */
     ...
     * @sysParam {Collection} collection - collection eg) node.childNodes, ...
     */
     ...
     *
     * @sysParam {Array} array - array
     * @sysParam {Function} fn - predicate function for cluster rule
     * @sysParam {Array[]}
     */
  ...
  var dom = (function () {
     ...
     *
     * @sysParam {Node} node
     * @sysParam {function} [pred] - predicate function
     * @return {Node[]}
     */
     ...
     *
     * @sysParam {Node} node
     * @sysParam {Function} [optional] pred - predicate function
     */
     ...
     *
     * @sysParam {Node} node
     * @sysParam {Node} tagName of wrapper
     * @return {Node} - wrapper
     */
     ...
     *
     * @sysParam {Node} node
     * @sysParam {Node} preceding - predicate function
     */
     ...
     *
     * @sysParam {BoundaryPoint} point
     * @sysParam {Boolean} isSkipInnerOffset
     ...
     *
     * @sysParam {BoundaryPoint} pointA
     * @sysParam {BoundaryPoint} pointB
     * @return {Boolean}
     */
     ...
     * @method walkPoint
     *
     * @sysParam {BoundaryPoint} startPoint
     * @sysParam {BoundaryPoint} endPoint
     * @sysParam {Function} handler
     * @sysParam {Boolean} isSkipInnerOffset
     */
     ...
     *
     * @sysParam {Node} ancestor - ancestor node
     * @sysParam {Node} node
     */
     ...
     *
     * @sysParam {Node} ancestor - ancestor node
     * @sysParam {array} offsets - offsetPath
     */
     ...
     * @sysParam {Boolean} [options.isSkipPaddingBlankHTML] - default: false
     * @sysParam {Boolean} [options.isNotSplitEdgePoint] - default: false
     ...
     *
     * @sysParam {Node} node
     * @sysParam {Boolean} isRemoveChild
     */
    ...
    /**
     * @sysParam {jQuery} $node
     * @sysParam {Boolean} [stripLinebreaks] - default: false
     */
     ...
     *
     * @sysParam {jQuery} $node
     * @sysParam {Boolean} [isNewlineOnBlock]
     */
     ...
     *
     * @sysParam {Node} an HTML DOM node
     */
  ...
  var range = (function () {
     ...
     *
     * @sysParam {TextRange} textRange
     * @sysParam {Boolean} isStart
     * @return {BoundaryPoint}
     *
     ...
     *
     * @constructor
     * @sysParam {Node} sc - start container
     * @sysParam {Number} so - start offset
     * @sysParam {Node} ec - end container
     * @sysParam {Number} eo - end offset
     */
    var WrappedRange = function (sc, so, ec, eo) {
      ...
      this.normalize = function () {
        ...
        /**
         * @sysParam {BoundaryPoint} point
         * @sysParam {Boolean} isLeftToRight
         * @return {BoundaryPoint}
         */
       ...
       * @sysParam {Function} [pred] - predicate function
       * @sysParam {Object} [options]
       * @sysParam {Boolean} [options.includeAncestor]
       * @sysParam {Boolean} [options.fullyContains]
       * @return {Node[]}
       */
      ...
      /**
       * @sysParam {Boolean} isCollapseToStart
       * @return {WrappedRange}
       */
       ...
       *
       * @sysParam {Boolean} [findAfter] - find after cursor, default: false
       * @return {WrappedRange}
       */
  ...
  var Style = function () {
     ...
     * @private
     * @sysParam  {jQuery} $obj
     * @sysParam  {Array} propertyNames - An array of one or more CSS properties.
     * @return {Object}
     */
     ...
     *
     * @sysParam {WrappedRange} rng
     * @sysParam {Object} styleInfo
     */
     ...
     *
     * @sysParam {WrappedRange} rng
     * @sysParam {Object} [options] - options for styleNodes
     * @sysParam {String} [options.nodeName] - default: `SPAN`
     * @sysParam {Boolean} [options.expandClosestSibling] - default: `false`
     * @sysParam {Boolean} [options.onlyPartialContains] - default: `false`
     * @return {Node[]}
     */
  ...
  var Bullet = function () {
     ...
     * toggle list
     *
     * @sysParam {String} listName - OL or UL
     */
     ...
     * @method releaseList
     *
     * @sysParam {Array[]} clustereds
     * @sysParam {Boolean} isEscapseToBody
     * @return {Node[]}
     */
   ...
   * @sysParam {object} startPoint Cell selected to apply change.
   * @sysParam {enum} where  Where change will be applied Row or Col. Use enum: TableResultAction.where
   * @sysParam {enum} action Action to be applied. Use enum: TableResultAction.requestAction
   * @sysParam {object} domTable Dom element of table to make changes.
   */
  var TableResultAction = function (startPoint, where, action, domTable) {
     ...
     * 
     * @sysParam {int} rowIndex Index position in line of virtual table.
     * @sysParam {int} cellIndex Index position in column of virtual table.
     * @sysParam {object} baseRow Row affected by this position.
     * @sysParam {object} baseCell Cell affected by this position.
     * @sysParam {bool} isSpan Inform if it is an span cell/row.
     */
     ...
     * 
     * @sysParam {object} virtualTableCellObj Object of specific position on virtual table.
     * @sysParam {enum} resultAction Action to be applied in that item.
     */
     ...
     * 
     * @sysParam {int} rowIndex Index of row to find free space.
     * @sysParam {int} cellIndex Index of cell to find free space in table.
     */
     ...
     * 
     * @sysParam {object} row Row to recover information.
     * @sysParam {object} cell Cell to recover information.
     */
     ...
     * 
     * @sysParam {int} rowIndex
     * @sysParam {int} cellIndex
     * @sysParam {object} cell
     * @sysParam {bool} isSelectedCell
     */
     ...
     * 
     * @sysParam {object} cell virtual table cell to apply action
     */
  ...
  */
  ...
  var Table = function () {
     ...
     *
     * @sysParam {WrappedRange} rng
     * @sysParam {String} position (top/bottom)
     * @return {Node}
     */
     ...
     *
     * @sysParam {WrappedRange} rng
     * @sysParam {String} position (left/right)
     * @return {Node}
     */
    ...
    *
    * @sysParam {object} Element to recover attributes.
    ...
    */
     ...
     *
     * @sysParam {Number} rowCount
     * @sysParam {Number} colCount
     * @return {Node}
     */
  ...
  var Editor = function (context) {
     ...
     * save current range
     *
     * @sysParam {Boolean} [thenCollapse=false]
     */
    ...
    /**
     * after command
     * @sysParam {Boolean} isPreventTrigger
     */
     ...
     *
     * @sysParam {String} src
     * @sysParam {String|Function} sysParam
     * @return {Promise}
     */
     ...
     * setting color
     *
     * @sysParam {Object} sObjColor  color code
     * @sysParam {String} sObjColor.foreColor foreground color
     * @sysParam {String} sObjColor.backColor background color
     */
     ...
     *
     * @sysParam {String} colorCode foreground color code
     */
     ...
     * insert Table
     *
     * @sysParam {String} dimension of table (ex : "5x5")
     */
    ...
    /**
     * @sysParam {Position} pos
     * @sysParam {jQuery} $target - target element
     * @sysParam {Boolean} [bKeepRatio] - keep ratio
     */
