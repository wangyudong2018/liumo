					...
					//	showColumns : true,
						...
						queryParams : function(params) {
							return {
                                ...
                                type:$("#help_type").val(),
                                title:$.trim($("#help_title").val()),
                                body:$.trim($("#help_body").val())
							};
						},
								...
								},
                                {
                                    ...
                                    formatter : function(value, row, index) {
                                        if (value == ""||value==null) {
                                            ...
                                            var img = '<img src="' + value + '" style="width: 50px;height: 50px;">';
                                            return img;
                                        }
                                    }
                                },
