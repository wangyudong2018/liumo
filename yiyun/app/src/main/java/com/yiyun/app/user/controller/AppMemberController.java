package com.yiyun.app.user.controller;
...
import com.yiyun.app.user.service.IMemberService;
...
//    private static final Logger logger = LogManager.getLogger(AppUsersController.class.getName());
    ...
    public String toLogin(String phone, String msgInputCode, String type, String redirectUrl, HttpServletResponse response) throws Exception {
        return "";
    }
    /**
     * @Title 前端用户登录
