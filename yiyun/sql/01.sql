...
CREATE TABLE `lm_user` (
  ...
  `positive_remark` varchar(500) DEFAULT NULL COMMENT '证件正面审核评语',
  `reverse_remark` varchar(500) DEFAULT NULL COMMENT '证件反面审核评语',
  `hand_remark` varchar(500) DEFAULT NULL COMMENT '手持证件照审核评语',
